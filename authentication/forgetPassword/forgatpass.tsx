  ...
  return (
    <div className="flex bg-white flex-col items-center">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center w-full mt-10 px-4">
        <div className="max-w-7xl w-full flex flex-col lg:flex-row bg-[#1a2235] rounded-lg shadow-2xl overflow-hidden">
          {/* Left Side: Form */}
          <div className="p-8 lg:p-10">
            <form>
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  className="py-1 mt-4 border w-44 px-5 border-gray-400 text-green-500 hover:bg-red-500 hover:text-white font-semibold rounded-xl"
                >
                  ভেরিফিকেশন করুন
                </button>
              </div>
