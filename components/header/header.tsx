...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="lg:px-10">
      <nav className="bg-white border lg:rounded-2xl rounded-xl shadow shadow-gray-400 text-black lg:px-44 sm:px-4 md:px-8 py-2 flex justify-between items-center">
        {/* Logo */}
        ...
        {/* Search Bar */}
        <div className="flex items-center border rounded-3xl lg:w-60 px-4 py-2 bg-gray-100 shadow-sm">
          {/* Search Icon */}
          <svg
          ...
          <input
            type="text"
            className="border-none outline-none bg-transparent w-full ml-2 text-gray-700 placeholder-gray-500"
